...
$sqlupdate="UPDATE tb_atraso SET ra = '$RAAtraso', motivo_atraso = '$MotivoAtraso', data_atraso = '$DataAtraso', horario = '$HorarioAtraso' WHERE id_atraso = '$IdAtraso'";

/* Realiza uma query MySQL em caso de erro exibe a mensagem*/
mysql_query($sqlupdate) or die ("Não foi possível alterar");

echo "<p class=\"lead\">Atraso alterado com sucesso!</p> ";
