...
$NomeAluno = $_POST['NovoNomeAluno'];
$RA = $_POST['NovoRA'];
$RAAntigo = $_POST['AntigoRA'];


$sqlinsert="UPDATE tb_aluno SET ra = '$RA', nome_aluno = '$NomeAluno' WHERE ra = '$RAAntigo'";

/* Realiza uma query MySQL em caso de erro exibe a mensagem*/
mysql_query($sqlinsert) or die ("Não foi possível alterar");

echo "<p class=\"lead\">Aluno alterado com sucesso!</p> ";
