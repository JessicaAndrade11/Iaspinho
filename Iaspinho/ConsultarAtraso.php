  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="starter-template">
        ...
        <h1>Consultar Atraso</h1>
        <p class="lead">

        </p>
         <form action="ConsultandoAtraso.php" method="post">
        
        <label for="inputRA" class="">Data do atraso que deseja consultar:</label>
        <input type="date" id="inputRA" name="DataAtraso" class="form-control" placeholder="Informe a Data do atraso que deseja consultar." required autofocus>
