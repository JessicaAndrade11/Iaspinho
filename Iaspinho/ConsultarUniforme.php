  ...
  <body>
          ...
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <li class="active"><a href="ConsultarAtraso.php">Consultar</a></li>
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <li class="active"><a href="ConsultarUniforme.php">Consultar</a></li>
    ...
    <div class="container">
      ...
      <div class="starter-template">
        ...
        <h1>Consultar falta de Uniforme</h1>
        <p class="lead">

        </p>
         <form action="ConsultandoUniforme.php" method="post">
        
        <label for="inputRA" class="">Data da ocorrência sem uniforme que deseja consultar:</label>
        <input type="date" id="inputRA" name="DataUniforme" class="form-control" placeholder="Informe a data da falta de Uniforme que deseja consultar." required autofocus>
        
      </br>
        <button class="btn btn btn-info" type="submit">Consultar</button>
