  ...
  <body>
          ...
          <ul class="nav navbar-nav">
            <li><a href="Home.html">Home</a></li>
              ...
              <ul class="dropdown-menu">
                ...
                <li class="active"><a href="ConsultarAluno.php">Consultar</a></li>
    ...
    <div class="container">
      ...
      <div class="starter-template">
        ...
        <h1>Consultar um Aluno</h1>
        <p class="lead">

        </p>
         <form action="ConsultandoAluno.php" method="post">
        
        <label for="inputRA" class="">RA ou Nome do aluno que deseja consultar:</label>
        <input type="text" id="inputRA" name="RANome" class="form-control" placeholder="Informe o RA ou Nome do aluno que deseja consultar." required autofocus>
        
      </br>
        <button class="btn btn btn-info" type="submit" name="ConsultaRA">Consultar pelo RA</button>
        <button class="btn btn btn-info" type="submit" name="ConsultaNome">Consultar pelo Nome</button>
      </form>
