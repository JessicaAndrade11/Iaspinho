...
switch (get_post_action('ConsultaRA','ConsultaNome')) {
  case 'ConsultaRA':
    
$sqlselect="SELECT * from tb_aluno WHERE ra = '$RANome'";
...
$sqlselect="SELECT * from tb_aluno WHERE nome_aluno LIKE '%".$RANome."%'";
$limite = mysql_query($sqlselect);
