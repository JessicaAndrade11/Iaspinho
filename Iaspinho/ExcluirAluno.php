  ...
  <body>
          ...
          <ul class="nav navbar-nav">
            <li><a href="Home.html">Home</a></li>
              ...
              <ul class="dropdown-menu">
                ...
                <li class="active"><a href="ExcluirAluno.php">Excluir</a></li>
              </ul>
            </li>
            <li class="dropdown">
    ...
    <div class="container">
      ...
      <div class="starter-template">
        ...
        <h1>Excluir registro de Aluno</h1>
        <p class="lead">

        </p>
         <form action="ExcluindoAluno.php" method="post">
        
        <label for="inputRA" class="">RA do aluno que deseja excluir:</label>
        <input type="number" id="inputRA" name="RA" class="form-control" placeholder="Informe o RA do aluno que deseja excluir." required autofocus>
