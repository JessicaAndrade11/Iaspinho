  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="starter-template">
        ...
        <h1>Excluir Atraso</h1>
        <p class="lead">

        </p>
         <form action="ExcluindoAtraso.php" method="post">
        
        <label for="inputRA" class="">Código do atraso que deseja excluir:</label>
        <input type="number" id="inputRA" name="IdAtraso" class="form-control" placeholder="Informe o código do atraso que deseja excluir." required autofocus>
