  ...
  <body>
          ...
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <li class="active"><a href="ExcluirAtraso.php">Excluir</a></li>
              </ul>
            </li>
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <li class="active"><a href="ExcluirUniforme.php">Excluir</a></li>
              </ul>
            </li>
    ...
    <div class="container">
      ...
      <div class="starter-template">
        ...
        <h1>Excluir falta de Uniforme</h1>
        <p class="lead">

        </p>
         <form action="ExcluindoUniforme.php" method="post">
        
        <label for="inputRA" class="">Código da falta de Uniforme que deseja excluir:</label>
        <input type="number" id="inputRA" name="IdUniforme" class="form-control" placeholder="Informe o código da falta de uniforme que deseja excluir." required autofocus>
